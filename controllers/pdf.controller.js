...
function runChildProcess(filesUploaded) {
  return new Promise((resolve, reject) => {
    ...
    pythoncapitalfinder.stdout.on('data', function (data) {
      let pdfData = data.toString().split(/\r?\n/);
      for (let i = 0; i < pdfData.length; i++) {
        newArr.push(Object.assign({}, pdfData[i].split(" ")))
      }
      console.log(newArr,'newArr logs',data.toString());
      resolve(newArr)
    });
...
function dateFormateChanger(finalArr, PdfYear) {

  finalArr.forEach((ele, i) => {
    if (ele.Date.startsWith("Jan") ||
      ele.Date.startsWith("Feb") ||
      ele.Date.startsWith("Mar") ||
      ele.Date.startsWith("Apr") ||
      ele.Date.startsWith("May") ||
      ele.Date.startsWith("Jun") ||
      ele.Date.startsWith("Jul") ||
      ele.Date.startsWith("Aug") ||
      ele.Date.startsWith("Sep") ||
      ele.Date.startsWith("Oct") ||
      ele.Date.startsWith("Nov") ||
      ele.Date.startsWith("Dec")) {
      let date = ele.Date.split(" ", 2)
      if (ele.Date.startsWith("Jan")) {
        const newDate = "01" + "/" + date[1] + "/" + PdfYear
        ele.Date = newDate
      } else if (ele.Date.startsWith("Feb")) {
        const newDate = "02" + "/" + date[1] + "/" + PdfYear
        ele.Date = newDate
      } else if (ele.Date.startsWith("Mar")) {
        const newDate = "03" + "/" + date[1] + "/" + PdfYear
        ele.Date = newDate
      } else if (ele.Date.startsWith("Apr")) {
        const newDate = "04" + "/" + date[1] + "/" + PdfYear
        ele.Date = newDate
      } else if (ele.Date.startsWith("May")) {
        const newDate = "05" + "/" + date[1] + "/" + PdfYear
        ele.Date = newDate
      } else if (ele.Date.startsWith("Jun")) {
        const newDate = "06" + "/" + date[1] + "/" + PdfYear
        ele.Date = newDate
      } else if (ele.Date.startsWith("Jul")) {
        const newDate = "07" + "/" + date[1] + "/" + PdfYear
        ele.Date = newDate
      } else if (ele.Date.startsWith("Aug")) {
        const newDate = "08" + "/" + date[1] + "/" + PdfYear
        ele.Date = newDate
      } else if (ele.Date.startsWith("Sep")) {
        const newDate = "09" + "/" + date[1] + "/" + PdfYear
        ele.Date = newDate
      } else if (ele.Date.startsWith("Oct")) {
        const newDate = "10" + "/" + date[1] + "/" + PdfYear
        ele.Date = newDate
      } else if (ele.Date.startsWith("Nov")) {
        const newDate = "11" + "/" + date[1] + "/" + PdfYear
        ele.Date = newDate
      } else if (ele.Date.startsWith("Dec")) {
        const newDate = "12" + "/" + date[1] + "/" + PdfYear
        ele.Date = newDate
      }
    } else if (!ele.Date.includes(" ") &&
      (ele.Date.startsWith("JAN") ||
        ele.Date.startsWith("FEB") ||
        ele.Date.startsWith("MAR") ||
        ele.Date.startsWith("APR") ||
        ele.Date.startsWith("MAY") ||
        ...
        ele.Date.startsWith("NOV") ||
        ele.Date.startsWith("DEC"))) {
      const date = ele.Date.slice(3, 6)
      if (ele.Date.startsWith("JAN")) {
        const newDate = "01" + "/" + date + "/" + PdfYear
        ele.Date = newDate
      } else if (ele.Date.startsWith("FEB")) {
        const newDate = "02" + "/" + date + "/" + PdfYear
        ele.Date = newDate
      } else if (ele.Date.startsWith("MAR")) {
        const newDate = "03" + "/" + date + "/" + PdfYear
        ele.Date = newDate
      } else if (ele.Date.startsWith("APR")) {
        const newDate = "04" + "/" + date + "/" + PdfYear
        ele.Date = newDate
      } else if (ele.Date.startsWith("MAY")) {
        const newDate = "05" + "/" + date + "/" + PdfYear
        ele.Date = newDate
      } else if (ele.Date.startsWith("JUN")) {
        const newDate = "06" + "/" + date + "/" + PdfYear
        ele.Date = newDate
      } else if (ele.Date.startsWith("JUL")) {
        const newDate = "07" + "/" + date + "/" + PdfYear
        ele.Date = newDate
      } else if (ele.Date.startsWith("AUG")) {
        const newDate = "08" + "/" + date + "/" + PdfYear
        ele.Date = newDate
      } else if (ele.Date.startsWith("SEP")) {
        const newDate = "09" + "/" + date + "/" + PdfYear
        ele.Date = newDate
      } else if (ele.Date.startsWith("OCT")) {
        const newDate = "10" + "/" + date + "/" + PdfYear
        ele.Date = newDate
      } else if (ele.Date.startsWith("NOV")) {
        const newDate = "11" + "/" + date + "/" + PdfYear
        ele.Date = newDate
      } else if (ele.Date.startsWith("DEC")) {
        const newDate = "12" + "/" + date + "/" + PdfYear
        ele.Date = newDate
      }
    } else if (
      ele.Date.startsWith("JAN") ||
    ...
    } else if ((ele.Date.startsWith("0") || ele.Date.startsWith("1") || ele.Date.startsWith("2") || ele.Date.startsWith("3")) && !ele.Date.includes("/")) {
      const date = ele.Date.slice(0, 2)
      if (ele.Date.endsWith("Jan")) {
        const newDate = "01" + "/" + date + "/" + PdfYear
        ele.Date = newDate
      } else if (ele.Date.endsWith("Feb")) {
        const newDate = "02" + "/" + date + "/" + PdfYear
        ele.Date = newDate
      } else if (ele.Date.endsWith("Mar")) {
        const newDate = "03" + "/" + date + "/" + PdfYear
        ele.Date = newDate
      } else if (ele.Date.endsWith("Apr")) {
        const newDate = "04" + "/" + date + "/" + PdfYear
        ele.Date = newDate
      } else if (ele.Date.endsWith("May")) {
        const newDate = "05" + "/" + date + "/" + PdfYear
        ele.Date = newDate
      } else if (ele.Date.endsWith("Jun")) {
        const newDate = "06" + "/" + date + "/" + PdfYear
        ele.Date = newDate
      } else if (ele.Date.endsWith("Jul")) {
        const newDate = "07" + "/" + date + "/" + PdfYear
        ele.Date = newDate
      } else if (ele.Date.endsWith("Aug")) {
        const newDate = "08" + "/" + date + "/" + PdfYear
        ele.Date = newDate
      } else if (ele.Date.endsWith("Sep")) {
        const newDate = "09" + "/" + date + "/" + PdfYear
        ele.Date = newDate
      } else if (ele.Date.endsWith("Oct")) {
        const newDate = "10" + "/" + date + "/" + PdfYear
        ele.Date = newDate
      } else if (ele.Date.endsWith("Nov")) {
        const newDate = "11" + "/" + date + "/" + PdfYear
        ele.Date = newDate
      } else if (ele.Date.endsWith("Dec")) {
        const newDate = "12" + "/" + date + "/" + PdfYear
        ele.Date = newDate
      }
    } else if (ele.Date.startsWith("01") ||
      ele.Date.startsWith("02") ||
      ele.Date.startsWith("03") ||
      ele.Date.startsWith("04") ||
      ele.Date.startsWith("05") ||
      ele.Date.startsWith("06") ||
      ele.Date.startsWith("07") ||
      ele.Date.startsWith("08") ||
      ele.Date.startsWith("09") ||
      ele.Date.startsWith("10") ||
      ele.Date.startsWith("11") ||
      ele.Date.startsWith("12")) {
      ele.Date = ele.Date + "/" + PdfYear
      ele.postDate = ele.postDate + "/" + PdfYear
    }
    if (ele.postDate !== undefined && (ele.postDate.startsWith("Jan") ||
        ele.postDate.startsWith("Feb") ||
        ele.postDate.startsWith("Mar") ||
        ele.postDate.startsWith("Apr") ||
        ele.postDate.startsWith("May") ||
        ele.postDate.startsWith("Jun") ||
        ele.postDate.startsWith("Jul") ||
        ele.postDate.startsWith("Aug") ||
        ele.postDate.startsWith("Sep") ||
        ele.postDate.startsWith("Oct") ||
        ele.postDate.startsWith("Nov") ||
        ele.postDate.startsWith("Dec"))) {
      let date = ele.postDate.split(" ", 2)
      if (ele.postDate.startsWith("Jan")) {
        const newDate = "01" + "/" + date[1] + "/" + PdfYear
        ele.postDate = newDate
      } else if (ele.postDate.startsWith("Feb")) {
        const newDate = "02" + "/" + date[1] + "/" + PdfYear
        ele.postDate = newDate
      } else if (ele.postDate.startsWith("Mar")) {
        const newDate = "03" + "/" + date[1] + "/" + PdfYear
        ele.postDate = newDate
      } else if (ele.postDate.startsWith("Apr")) {
        const newDate = "04" + "/" + date[1] + "/" + PdfYear
        ele.postDate = newDate
      } else if (ele.postDate.startsWith("May")) {
        const newDate = "05" + "/" + date[1] + "/" + PdfYear
        ele.postDate = newDate
      } else if (ele.postDate.startsWith("Jun")) {
        const newDate = "06" + "/" + date[1] + "/" + PdfYear
        ele.postDate = newDate
      } else if (ele.postDate.startsWith("Jul")) {
        const newDate = "07" + "/" + date[1] + "/" + PdfYear
        ele.postDate = newDate
      } else if (ele.postDate.startsWith("Aug")) {
        const newDate = "08" + "/" + date[1] + "/" + PdfYear
        ele.postDate = newDate
      } else if (ele.postDate.startsWith("Sep")) {
        const newDate = "09" + "/" + date[1] + "/" + PdfYear
        ele.postDate = newDate
      } else if (ele.postDate.startsWith("Oct")) {
        const newDate = "10" + "/" + date[1] + "/" + PdfYear
        ele.postDate = newDate
      } else if (ele.postDate.startsWith("Nov")) {
        const newDate = "11" + "/" + date[1] + "/" + PdfYear
        ele.postDate = newDate
      } else if (ele.postDate.startsWith("Dec")) {
        const newDate = "12" + "/" + date[1] + "/" + PdfYear
        ele.postDate = newDate
      }
    }
...
console.log(newArr);
      let newFilteredArray = newArr.filter((ele) => {
        return (Object.keys(ele).length < 12 && Object.keys(ele).length > 0)
      })
      // console.log(newFilteredArray,'filtered array');
      let pdfs = [];
      // let pdf = JSON.parse(fs.readFileSync('./pdf.json', 'utf-8'));
      let pdfObj = Object.values(newFilteredArray);
      ...
      if (ispdfType.includes("www.servus.ca/mastercard")) {
        ...
        for (let i = 0; i < newArrayOfObj1.length; i++) {
          if (newArrayOfObj1[i].Date === "Statement") {
            var DateYear = newArrayOfObj1[i + 2].Date
            break;
          }
        }
        var PdfDate = DateYear.split("/", 3)
        var PdfYear = (PdfDate.splice(2, 1)).toString().replace(" ", "")
        for (let i = 0; i < newArrayOfObj1.length; i++) {
          if (newArrayOfObj1[i].Date === "BL") {
            customerName.push(newArrayOfObj1[i + 2].Date + newArrayOfObj1[i + 2].postDate + newArrayOfObj1[i + 2].description)
          }
        }
        ...
        for (let i = 0; i < newArrayOfObj1.length; i++) {
          if (newArrayOfObj1[i].postDate === "Only") {
            final = newArrayOfObj1.slice(i + 1, newArrayOfObj1.length)
          }
        }
        ...
        final.forEach((ele, i) => {
          ...
          if (ele.spendCategories === undefined) {
            ele.spendCategories = ""
          }
          if (ele.val5 == undefined) {
            ele.val5 = ""
          }
          if (ele.val4 == undefined) {
            ele.val4 = ""
          }
          if (ele.val3 == undefined) {
            ele.val3 = ""
          }
          if (ele.val2 == undefined) {
            ele.val2 = ""
          }
          if (ele.val1 == undefined) {
            ele.val1 = ""
          }
        ...
        final.forEach((ele, i) => {
          if (ele.val5.startsWith('$')) {
            ...
            ele.Date = ele.Date + ele.postDate
            ele.postDate = ""
          }
          if (ele.postDate === "####") {
            ele.postDate = ele.Date + ele.postDate + ele.description
            ele.Date = ""
            ele.description = ""
          }
          if (!ele.amount.startsWith("$") && ele.Date !== "" && ele.postDate !== "") {
            ele.description = ele.Date + " " + ele.postDate + " " + ele.description + " " + ele.amount
            ele.Date = "",
              ele.postDate = "",
              ele.spendCategories = "",
              ele.amount = ""
        ...
        for (let i = 1; i < final.length; i++) {
          if (final[i - 1].Date !== "" && final[i].Date === "" && final[i + 1].Date !== '') {
        ...
        dateFormateChanger(servus_mc, PdfYear)

        await pdfCollection.doc().set(servusMcObject);
        ...
        var PdfYear
        for (let i = 0; i < newArrayOfObj1.length; i++) {
          if (newArrayOfObj1[i].Date === "For") {
            PdfYear = newArrayOfObj1[i].val2
          }
        }
        for (let i = 0; i < newArrayOfObj1.length; i++) {
        ...
        dateFormateChanger(finalArr, PdfYear)
        const bmoObject = {
          Pdf: {
            StaticData: staticData,
            TableData: finalArr,
        ...
        newArrayOfObj1.forEach((ele, i) => {
          ...
          if (ele.Withdrawals === undefined) {
            ele.Withdrawals = ""
          }
          if (ele.Deposits == undefined) {
            ele.Deposits = ""
          }
          if (ele.Balance == undefined) {
            ele.Balance = ""
          }
          if (ele.val7 == undefined) {
            ele.val7 = ""
          }if (ele.val6 == undefined) {
            ele.val6 = ""
          }
          if (ele.val5 == undefined) {
            ele.val5 = ""
        ...
        console.log(newArrayOfObj1,'atb');
        var PdfYear
        for (let i = 0; i < newArrayOfObj1.length; i++) {
          if (newArrayOfObj1[i].Date === "Statement") {
            PdfYear = newArrayOfObj1[i].Balance
          }
        }
    ...
    let fileteredAtbArray = ATB.filter((ele)=> ele.Date !=="" && ele.Balance !=="")
        const AtbObject = {
          Pdf: {
            StaticData: staticData,
            TableData: fileteredAtbArray,
          },
        };
        dateFormateChanger(ATB, PdfYear)
      ...
      async function confrim() {
        ...
        if (ispdfType.includes("http://www.servus.ca")) {
          ...
          for (let i = 0; i < newArrayOfObj1.length; i++) {
            if (newArrayOfObj1[i].Date === "All in One") {
              var DateYear = newArrayOfObj1[i + 1].Description
            }
          }
          var PdfDate = DateYear.split(",", 2)
          var PdfYear = (PdfDate.splice(1, 1)).toString().replace(" ", "")
          ...
          dateFormateChanger(balance, PdfYear)
          ...
          for (var i = 0; i < newArrayOfObj1.length; i++) {
            if (newArrayOfObj1[i].Date.includes("Card")) {
              customerName.push(newArrayOfObj1[i].postDate)
              accountNumber.push(newArrayOfObj1[i].Date)
            }
          }
          ...
          newArrayOfObj1.forEach((element, i) => {
            if (element.preTax !== undefined) {
              newArrayOfObj1[i].transId = newArrayOfObj1[i + 1].Date;
          ...
          for (let i = 0; i < balance.length; i++) {
            if (balance[i].Date === "TOTAL CREDITS") {
              balance.splice(i, balance.length);
            }
          }
          const bmoObject = {
          ...
          for (let i = 0; i < newArrayOfObj1.length; i++) {
            if (newArrayOfObj1[i].Date === "Statement date: ") {
              var DateYear = newArrayOfObj1[i].Description
            }
          }
          var PdfYear = DateYear.slice(5, 9)
          for (let i = 0; i < newArrayOfObj1.length; i++) {
            if (newArrayOfObj1[i].Date === "Statement of Accounts") {
              var customerCWB = newArrayOfObj1[i + 1].Date;
            }
            if (newArrayOfObj1[i].Date === "Customer No.: ") {
              var customernoCWB = newArrayOfObj1[i].Description;
            }
          }
          let staticData = {
            StatementType: "FINANCE STATEMENT",
            ...
            UploadedMonth: moment().format("MMMM"),
            Date: demo.getTime(),
            CustomerName: customerCWB,
            CustomerNo: customernoCWB,
            StatementDate: "31/01/2020",
            Interest: "647.56",
            BusinessType: "--",
            ExpenseType: "",
          ...
          for (let i = 0; i < newArrayOfObj1.length; i++) {
            if (newArrayOfObj1[i].Date.includes("Management")) {
              var CWB = newArrayOfObj1.slice(i + 3, newArrayOfObj1.length);
            }
          }
          CWB.forEach((ele, i) => {
            if (ele.Description === "PAYMENTS" && ele.Date === "TOTAL:") {
              CWB.splice(i - 3, CWB.length);
            }
            if (ele.Date.includes("(Continued)")) {
              CWB.splice(i, 10);
            }
            if (ele.Date === "Loan(s)") {
              CWB.splice(i - 9, 17);
            }
            if (ele.Date === "CREDIT LIMIT:") {
              CWB.splice(i - 1, 24);
            }
          });

          for (let i = 1; i < CWB.length; i++) {
            if (
              CWB[i].Description === undefined &&
              CWB[i + 1].Description === undefined
            ) {
              CWB[i - 1].Description =
                CWB[i - 1].Description +
                " " +
                ...
                CWB[i + 1].Date;
              CWB.splice(i, 2);
            } else if (CWB[i].Description === undefined) {
              CWB[i - 1].Description =
                CWB[i - 1].Description + " " + CWB[i].Date;
              CWB.splice(i, 1);
            }
          }
          CWB.forEach((ele) => {
          ...
          dateFormateChanger(CWB, PdfYear)
        ...
        //cwb ends here....
          ...
          tableData.forEach((ele, i) => {
            if (ele.Date === "PETROCAN-141 CENTURY CROS SPRUCE GROVE") {
              tableData[i].description =
                tableData[i].Date + " " + tableData[i + 1].postDate;
              tableData[i].referenceNumber = tableData[i].oddreferenceNumber;
              tableData[i].Date = tableData[i].postDate;
              tableData[i].postDate = tableData[i + 1].Date;
          ...
          for (let i = 0; i < newArrayOfObj1.length; i++) {
            if (newArrayOfObj1[i].Date === "Account number") {
              var DateYear = newArrayOfObj1[i - 1].Description
            }
          }
          var PdfDate = DateYear.split(",", 2)
          ...
          dateFormateChanger(cibc, PdfYear)
          ...
          for (let i = 0; i < static.length; i++) {
            if (static[i].Date === "Statement Date") {
              var DateYear = static[i + 1].Date
            }
          }
          var PdfDate = DateYear.split(",", 2)
          var PdfYear = (PdfDate.splice(1, 1)).toString().replace(" ", "")
          ...
          for (var i = 0; i < static.length; i++) {
            if (static[i].Date === "TM" && static[i].postDate === "TM1") {
              customerName.push(static[i - 1].Date)
            }
            if (static[i].Date === "TM" && static[i].postDate === "TM1") {
              accountNumber.push(static[i + 3].Date)
            }
          }
          let acountnm = customerName.toString()
          ...
          dateFormateChanger(tableData, PdfYear)
          ...
          for (let i = 0; i < static.length; i++) {
            if (static[i].referenceNumber === "Statement Period") {
              var DateYear = static[i].Date
            }
          }
          var PdfDate = DateYear.split(",", 2)
          var PdfYear = (PdfDate.splice(1, 1)).toString().replace(" ", "")
          for (var i = 0; i < static.length; i++) {
            if (static[i].referenceNumber === "P") {
              accountNumber.push(static[i + 1].Date)
            }
          ...
          newArrayOfObj1.forEach((element) => {
            ...
            if (element.Date === " -") {
              element.Date = element.referenceNumber + element.Date + element.postDate + element.description;
              element.referenceNumber = ""
              element.postDate = ""
              element.description = ""
              element.amount = ""
          ...
          for (let i = 0; i < tableData.length; i++) {
            if (tableData[i].Date === "CALGARYAB") {
              var DateYear = tableData[i + 1].Date
            }
          }
          var PdfDate = DateYear.split(",", 3)
          var PdfYear = (PdfDate.splice(2, 1)).toString().replace(" ", "")
          ...
          for (let i = 1; i < RBC.length; i++) {
            if (RBC[i].Date === "") {
              RBC[i].Date = RBC[i - 1].Date
            }
          }
          ...
          dateFormateChanger(RBC, PdfYear)
          ...
          for (let i = 0; i < static.length; i++) {
            if (static[i].Date === "STATEMENT") {
              var DateYear = static[i].val4
            }
          }
          var PdfYear = DateYear
          ...
          for (let i = 0; i < newArrayOfObj1.length; i++) {
            if (newArrayOfObj1[i].Date === "RBCROYAL") {
          ...
          newArrayOfObj1.forEach((ele, i) => {
            ...
            if (ele.val8 !== undefined) {
              ...
              ele.val8 = undefined
              ele.val9 = undefined
            } else if (ele.description === undefined && ele.Date !== undefined && ele.postDate !== undefined) {
              ele.amount = "$"
            } else if (ele.Date !== undefined && ele.postDate === undefined) {
              ele.amount = "$"
            ...
            if (ele.amount === undefined && ele.description !== undefined && ele.Date !== undefined &&
              ele.postDate !== undefined) {
              ele.amount = "-$"
            }

            if (ele.Date === "Purchases" || ele.Date === "CONTACT" ||
              ele.Date === "Annual" || ele.Date === "Previous" || ele.Date.endsWith("&")) {
          ...
          filterArray.forEach((element, i) => {
            ...
            } else if (element.Date.endsWith("%")) {
              element.amount = undefined
            } else if (element.Date === "TRANSACTION" || element.Date === "DATE" ||
              element.Date === "Website" || element.Date === "STATEMENT" ||
              element.Date === "mobile" || element.Date === "ForeignCurrency-USD") {
              element.amount = undefined
            }
          ...
          for (let i = 0; i < result.length; i++) {
            ...
            if (result[i].postDate === undefined) {
              result[i]['transId'] = result[i]['Date'];
          ...
          result.forEach((res) => {
            if (res.transId !== undefined) {
              ...
              res.val8 = ""
              res.val9 = ""
            } else if (res.Date !== undefined && res.postDate !== undefined && res.description === undefined) {
              res.Date = res.Date + res.postDate
              res.postDate = ""
              res.description = ""
              res.amount = ""
              res.transId = ""
              ...
              res.Date = res.Date + res.postDate + res.description + res.amount
              res.postDate = ""
              res.description = ""
              res.amount = ""
              res.transId = ""
              ...
              res.val8 = ""
              res.val9 = ""
            } else if (res.Date !== undefined && res.postDate !== undefined &&
              res.description !== undefined && res.val1 === undefined) {
              res.Date = res.Date + res.postDate + res.description
              res.postDate = ""
              res.description = ""
              res.amount = ""
              res.transId = ""
          ...
          for (var i = 0; i < result.length; i++) {
            if (result[i].Date.includes("****")) {
              accountNumber.push(result[i].Date)
              customerName.push(result[i - 1].Date)
            }
          }
          let acountnm = customerName.toString()
          let acountnbr = accountNumber.toString()
          ...
          dateFormateChanger(result, PdfYear)
          ...
          for (let i = 0; i < newArrayOfObj1.length; i++) {
            if (newArrayOfObj1[i].Date === "STATEMENT" && newArrayOfObj1[i].postDate === "DATE:") {
              var PdfYear = newArrayOfObj1[i].val1
            }
          }
          var RegExp = /[0-9]/g
          for (let i = 0; i < newArrayOfObj1.length; i++) {
            if (newArrayOfObj1[i].Date === "CONTACT") {
              var companyName = newArrayOfObj1[i + 3].Date + " " + newArrayOfObj1[i + 3].postDate + " " + newArrayOfObj1[i + 3].description
            }
            if (newArrayOfObj1[i].description === "TRAVEL" && newArrayOfObj1[i].amount === "VISA") {
              if (newArrayOfObj1[i].amount.search(RegExp)) {
                var costmTD = newArrayOfObj1[i + 2].Date + " " + newArrayOfObj1[i + 2].postDate + " " + newArrayOfObj1[i + 2].description
              } else {
                var costmTD = newArrayOfObj1[i + 2].Date + " " + newArrayOfObj1[i + 2].postDate + " " + newArrayOfObj1[i + 2].description + " " + newArrayOfObj1[i + 2].amount
              }
            }
            if (newArrayOfObj1[i].description === "TRAVEL" && newArrayOfObj1[i].amount === "VISA") {
              var acctTD = newArrayOfObj1[i + 1].Date + " " + newArrayOfObj1[i + 1].postDate + " " + newArrayOfObj1[i + 1].description + " " + newArrayOfObj1[i + 1].amount
            }
          }
          ...
          for (let i = 0; i < newArrayOfObj1.length; i++) {
            if (
              newArrayOfObj1[i].Date === "TRANSACTION" &&
          ...
          TDVisa.forEach((ele, i) => {
            if (TDVisa[i].Date === "TD" && TDVisa[i].postDate === "CANADA") {
              TDVisa.splice(i, 10)
            }
            if (
            ...
            if (TDVisa[i].Date.includes("Continued")) {
              TDVisa.splice(i, 8);
            }
            if (ele.Date === "Available" || ele.Date === "Annual") {
              TDVisa.splice(i, 1)
            }
          });
          TDVisa.forEach((ele, i) => {
            if (
              TDVisa[i].Date.includes("CALCULATING") ||
              TDVisa[i].Date.includes("Previous") ||
              TDVisa[i].Date.includes("Purchases") ||
              TDVisa[i].Date.includes("Cash") ||
              TDVisa[i].Date.includes("Sub-total") ||
              TDVisa[i].Date.includes("Payments")
            ...
            if (TDVisa[i].Date.includes("NEW") && TDVisa[i].description === "MINIMUM") {
              TDVisa.splice(i, 1)
            }

            if (TDVisa[i].Date.includes("Fees")) {
              TDVisa.splice(i, 14);
            }
            if (TDVisa[i].Date.includes("Interest")) {
              TDVisa.splice(i, 1);
            }
            if (TDVisa[i].postDate.includes("Make") && TDVisa[i].description.includes("cheques")) {
              TDVisa.splice(i, 7)
            }
            if (TDVisa[i].Date === "TOTAL" && TDVisa[i].postDate === "NEW") {
              TDVisa.splice(i + 1, TDVisa.length)
            }
          });
          TDVisa.forEach((ele, i) => {
            if (ele.Date.length < 3) {
              ele.Date = ele.postDate
          ...
          for (let i = 1; i < TDVisa.length; i++) {
            if ((!TDVisa[i].Date.startsWith("JAN") ||
                !TDVisa[i].Date.startsWith("FEB") ||
                !TDVisa[i].Date.startsWith("MAR") ||
                !TDVisa[i].Date.startsWith("APR") ||
                !TDVisa[i].Date.startsWith("MAY") ||
                !TDVisa[i].Date.startsWith("JUN") ||
                !TDVisa[i].Date.startsWith("JUL") ||
                !TDVisa[i].Date.startsWith("AUG") ||
                !TDVisa[i].Date.startsWith("SEP") ||
                !TDVisa[i].Date.startsWith("OCT") ||
                !TDVisa[i].Date.startsWith("NOV") ||
                !TDVisa[i].Date.startsWith("DEC")) && (!TDVisa[i].amount.startsWith("$")) && (!TDVisa[i].amount.startsWith("-"))) {
              TDVisa[i].description = TDVisa[i].Date + " " + TDVisa[i].postDate + "" + TDVisa[i].description + " " + TDVisa[i].amount
              TDVisa[i].Date = ""
              TDVisa[i].postDate = ""
              TDVisa[i].amount = ""
          ...
          for (let i = 1; i < TDVisa.length; i++) {
            ...
            if (TDVisa[i].Date.startsWith("JAN") ||
              ...
              TDVisa[i].Date.startsWith("OCT") ||
              TDVisa[i].Date.startsWith("NOV") ||
              TDVisa[i].Date.startsWith("DEC")) {

              if (TDVisa[i + 1].Date === "" && TDVisa[i + 2].Date === "" && !TDVisa[i + 1].val1.includes("$")) {
              ...
              if (TDVisa[i].Date === "" && TDVisa[i].description.includes("NET")) {
                if (TDVisa[i + 1].Date === "") {
                  TDVisa[i].description = TDVisa[i].description + " " + TDVisa[i + 1].description
                  TDVisa.splice(i + 1, 1)
                }
          ...
          TDVisa.forEach((ele, i) => {
            if (TDVisa[i].description === "BALANCE") {
              TDVisa[i].description = TDVisa[i].Date + " " + TDVisa[i].postDate + " " + TDVisa[i].description
              TDVisa[i].Date = ""
              TDVisa[i].postDate = ""
            }
          })
          TDVisa.forEach((ele, i) => {
            if (TDVisa[i].Date.startsWith("JAN") ||
              ...
              TDVisa[i].Date.startsWith("OCT") ||
              TDVisa[i].Date.startsWith("NOV") ||
              TDVisa[i].Date.startsWith("DEC") || (TDVisa[i].Date === "" && (TDVisa[i].amount.startsWith("$") || TDVisa[i].val1.includes("$")))) {
              ele.val8 = "undefined"
            }
          })
          ...
          dateFormateChanger(TDVisa, PdfYear)
...
const searchPdf = async (req, res, next) => {
  ...
  try {
    ...
    if (data.empty) {
      ...
      if (CustomerName !== undefined && MerchantName !== undefined && StatementType !== undefined && startDate !== undefined && endDate !== undefined) {
        list.forEach((ele, i) => {
          if (ele.Pdf.StaticData.StatementType === StatementType) {
            if (CustomerName !== undefined) {
              if (ele.Pdf.StaticData.CustomerName.toUpperCase().includes(CustomerName.toUpperCase()) === CustomerName.toUpperCase().includes(CustomerName.toUpperCase())) {
                const cusData = Object.values(list[i])
                const finalData = cusData[1].TableData
                dataRes.push(finalData);
              }
              ...
              if (ele.Pdf.StaticData.FinancialInstitution.toUpperCase().includes(MerchantName.toUpperCase()) === MerchantName.toUpperCase().includes(MerchantName.toUpperCase())) {
                const merData = Object.values(list[i])
                const finalData = merData[1].TableData
                dataRes.push(finalData);
              }
              ...
              if (ele.Pdf.StaticData.EmployeeID !== undefined) {
                if (ele.Pdf.StaticData.EmployeeID.toUpperCase().includes(CustomerID.toUpperCase()) === CustomerID.toUpperCase().includes(CustomerID.toUpperCase())) {
                  const idData = Object.values(list[i])
                  const finalData = idData[1].TableData
                  dataRes.push(finalData);
              ...
              let PdfTableDate = ele.Pdf.TableData;
              for (let i = 0; i < PdfTableDate.length; i++) {
                if (PdfTableDate[i].Date.startsWith("01") ||
                  PdfTableDate[i].Date.startsWith("02") ||
                  PdfTableDate[i].Date.startsWith("03") ||
                  PdfTableDate[i].Date.startsWith("04") ||
                  PdfTableDate[i].Date.startsWith("05") ||
                  PdfTableDate[i].Date.startsWith("06") ||
                  PdfTableDate[i].Date.startsWith("07") ||
                  PdfTableDate[i].Date.startsWith("08") ||
                  PdfTableDate[i].Date.startsWith("09") ||
                  PdfTableDate[i].Date.startsWith("10") ||
                  PdfTableDate[i].Date.startsWith("11") ||
                  PdfTableDate[i].Date.startsWith("12")
                ) {
                  var PdfDate = PdfTableDate[i].Date
                  const PdfMili = new Date(PdfDate);
                  var PdfDateMili = PdfMili.getTime()
                }
                if (
                  startDateMili <= PdfDateMili &&
                  PdfDateMili <= endDateMili
                ) {
                  dataRes.push(ele.Pdf.TableData[i]);
                }
              }
            }
